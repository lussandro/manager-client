...
export default {
  ...
  about: {
    title: "About",
    description: "ChatCoreAPI Manager makes it easy to manage your APIs with an intuitive interface. It was created by independent developers, focusing on improving the user experience and administration of API functionalities.",
